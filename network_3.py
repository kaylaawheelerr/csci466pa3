...
class NetworkPacket:
    ...
    def from_byte_S(self, byte_S):
        origin_addr = int(byte_S[0 : NetworkPacket.origin_addr_S_length])
        dst_addr = int(byte_S[NetworkPacket.origin_addr_S_length : NetworkPacket.origin_addr_S_length + NetworkPacket.dst_addr_S_length])
        data_S = byte_S[NetworkPacket.origin_addr_S_length + NetworkPacket.dst_addr_S_length : ]
