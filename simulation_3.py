...
if __name__ == '__main__':
    ...
    router_a = network.Router(name='A', intf_count=2, max_queue_size=router_queue_size, routing_dictionary=table["A"])
    router_b = network.Router(name='B', intf_count=1, max_queue_size=router_queue_size, routing_dictionary=table["B"])
    router_c = network.Router(name='C', intf_count=1, max_queue_size=router_queue_size, routing_dictionary=table["C"])
    router_d = network.Router(name='D', intf_count=2, max_queue_size=router_queue_size, routing_dictionary=table["D"])
    ...
    client_1.udt_send(3, 'Some Sample Data.')
    client_2.udt_send(4, 'Some Sample Data.')
